export default function Page() {
  return (
    <div className="p-6">
      <h1 className="text-4xl font-bold mb-6">問題</h1>
      <p className="pb-4">
      ...
      <p className="pb-6">
        また、関数は戻り値として配列を返すのではなく、渡された元の Array を変更し、並べ替えを行なってください。
      </p>
      <h3 className="text-2xl font-bold mb-2">制限</h3>
      <ul className="list-disc list-inside pl-2">
        <li>1 &le; nums.length &le; 105</li>
        <li>-231 &le nums[i] &le; 231 - 1</li>
        <li>0 &le; k &le; 105</li>
      </ul>
    </div>
  );
